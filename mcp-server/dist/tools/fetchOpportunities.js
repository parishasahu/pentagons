...
export const fetchOpportunities = {
    definition: {
        ...
        description: "Called from inside App 1 after the student submits their profile. Runs the discover agent to find matching schemes. Returns structured { profile, schemes } data.",
    ...
    handler: async (input) => {
        ...
        return {
            ...
            structuredContent: { profile: input.profile, schemes },
        };
    },
};
//# sourceMappingURL=fetchOpportunities.js.map