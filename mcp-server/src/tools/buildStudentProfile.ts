...
export const buildStudentProfile = {
  definition: {
    ...
    description:
      "Opens the student onboarding form (App 1) as an embedded MCP app resource. The user fills in personal, academic, and income details.",
    inputSchema: InputSchema,
  },
  handler: async (_input: z.infer<typeof InputSchema>) => {
